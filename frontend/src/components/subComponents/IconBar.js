    ...
    return (
        ...
        border-r-[1px] border-borderColor flex-col flex justify-between">
            <div onClick={toggleExplorer} className='flex flex-row cursor-pointer'>
                ...
                <DocumentDuplicateIcon className="w-[4.25rem] h-[4.25rem] text-textMain p-3"></DocumentDuplicateIcon>
            </div>
            <div className="flex flex-col">
                ...
                <div className="group w-auto h-auto m-[0.8rem] flex justify-center items-center group cursor-pointer">
                    <a href="https://www.linkedin.com/in/cameron-thomas-595417251/" target="_blank" rel="noopener noreferrer">
                        <svg className="w-10 h-auto fill-current fill-iconBarBackground text-textSecondary group-hover:textMain" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="64" height="64">
